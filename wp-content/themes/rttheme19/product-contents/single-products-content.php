				...
				<div class="row <?php echo $content_width == "1/1" ? 'fixed_heights' : '';?> ">
					...
					<?php endif;?>
							...
							<?php 
								...
								echo rt_create_image_carousel(array("rt_gallery_images" => $gallery_images, "column_width" => "6/12", "carousel_atts" => $carousel_atts, "w" => "", "h" => "") ) ;
			...
			<?php 
				...
				if( $tabbed_page ){
					...
					if( $content_style != "4" ){ // Tabular style
						...
						// Main content - General Details Tab	
						$accordion_content =  $content ? sprintf('[rt_accordion_content id="accordion-general-details" title="%2$s" icon_name="icon-doc-alt"]%1$s[/rt_accordion_content]', $content, __('General Details','rt_theme') ) : "";
