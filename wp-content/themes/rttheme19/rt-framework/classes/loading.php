...
class RTTheme{
	...
	function rt_create_menus() {
		...
		register_nav_menu( 'rt-theme-main-navigation', __( 'Main Navigation' , 'rt_theme_admin') ); 
		register_nav_menu( 'rt-theme-footer-navigation', __( 'Footer Navigation' , 'rt_theme_admin' ));  
		
		wp_create_nav_menu( 'Main Navigation', array( 'slug' => 'rt-theme-main-navigation' ) );
		wp_create_nav_menu( 'Footer Navigation', array( 'slug' => 'rt-theme-footer-navigation') ); 
		...
		//activate revslider 
				$plugins = array(
					...
					array(
						...
						'version'               => '1.5.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
