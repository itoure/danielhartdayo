...
#-----------------------------------------
	...
	#	
	vc_set_shortcodes_templates_dir( RT_EXTENTIONS_PATH . 'vc_templates' );
	...
	function rt_add_vc_shortcodes() { 
		...
		foreach ($module_list as $module_name) {
			include(RT_EXTENTIONS_PATH . "/inc/editor/".$module_name.".php");
		}
	 ...
	 */
	function rt_vc_description_function( $param, $param_value ) {
		$param_line = '<p>'.$param_value.'</p>';
		return $param_line;
	}
