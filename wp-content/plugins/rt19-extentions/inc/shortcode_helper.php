...
class rt_shortcode_helper{
	...
	public function start() { 
		...
		//start
		add_action('admin_footer', array(&$this,'create_shortcode_list') );
					...
					"rt_slider" => array(
						...
						"parameters" => array(
											...
											array(
												...
												'heading'     => __('Minumum Slider Height (px)', 'rt_theme_admin' ),
					...
					*/			
					"rt_image_gallery" => array(
						...
						[photo_gallery item_width="5"]
							[rt_gal_item image_id="" title="Image 1 Title" action="lightbox" custom_link="" link_target="" id="" class=""]Description of the image[/rt_gal_item]
							[rt_gal_item image_id="" title="Image 2 Title" action="lightbox" custom_link="" link_target="" id="" class=""]Description of the image[/rt_gal_item]
							[rt_gal_item image_id="" title="Image 3 Title" action="lightbox" custom_link="" link_target="" id="" class=""]Description of the image[/rt_gal_item]
						[/photo_gallery]			 
						',				
