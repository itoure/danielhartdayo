...
$customFields = array(
				...
				array(
  				...
  				array(
					...
					array(
	 				...
	 				array(
						"description" => __('Image format options. Image format portfolio item can have more then one image attached to it. Default the attached images will be shown in a slider. It can be changed to type gallery in which case a image gallery is shown. If there is only one image the slideshow and gallery display options will be ignored and the featured image will be displayed.','rt_theme_admin'),					
						"type"        => "info_text_only",
						"hr"          => "true",
					), 
					...
					array(
						"title"      => __("Photo Gallery Layout",'rt_theme_admin'),
						"desc"       => __("Select a layout for the photo gallery",'rt_theme_admin'),
				...
				array(
  				...
  				array(
					...
					array(
						"description" => __("Attach an image to the <strong>Image Gallery </strong> box to act as a placeholder / poster image for this video item. Attach only ONE image.",'rt_theme_admin'),											
						"type"        => "info_text_only",
						"hr"          => "true",
					),
				...
				array(
					...
					array(
						"description" => __("Attach an image to the <strong>Image Gallery </strong> box to act as a placeholder / poster image for this audio item. Attach only ONE image.",'rt_theme_admin'),					
						"type"        => "info_text_only", 
						"hr"          => "true",
					),
				...
				array(
					"title" => __("SINGLE PORTFOLIO PAGE RELATED OPTIONS",'rt_theme_admin'),
					"type"  => "heading"
				),

				array(
					"title"       => __("Hide the Featured Image in the Single Post Page",'rt_theme_admin'),
					"name"        => "_hide_featured_image_single_page",
					"description" => __('By default the featured image will be displayed as a first item in a single portfolio page formats. You can remove it be checking this option.','rt_theme_admin'),
					"default"     => "", 
					"hr"          => "true",
					"type"        => "checkbox",
				),	
				...
				array(
					"title"       => __("Display the Featured Media (Video, Audio or Image Gallery) in a Fullwidth Row. ",'rt_theme_admin'),
					"name"        => "_portfolio_featured_media_width",
					"description" => __('If you created the portfolio content by using the Visual Composer, you can check this field to display the added featured media in a full width row.','rt_theme_admin'),
					"default"     => "", 
					"type"        => "checkbox"
				),
				...
				array(
					...
					"description" => __("Check this option to disable the linking to the Single Portfolio Item in the Portfolio Listing Pages.",'rt_theme_admin'),
					"type"        => "checkbox",
					"hr"          => true,
				),
...
$settings  = array( 
	"name"       => __("Portfolio Options",'rt_theme_admin'),
	"scope"      => "portfolio",
...
$customFields = array(
	...
	array(
		"description" => __("These options are only for listing pages. Select the 'Customize for this post' option below to overwite the global portfolio settings for this post only.",'rt_theme_admin'),					
		"type"        => "info_text_only",
		"hr"          => true
	),
	...
	array(
		...
		"desc"    => __('Select and set to use the global settings or customize the cropping and dimension settings for this post.','rt_theme_admin'),
		...
		array( 
			...
			array(
				"title"         => __("Resize Featured Resize",'rt_theme_admin'),
			...
			array(
				...
				"description" => __('By turning "ON" the cropping option the featured image will be cropped according to the height and width values above.','rt_theme_admin'),
				"default"     => "",
				"type"        => "checkbox",
				"dependency"  => array( "element" => "rttheme_portfolio_image_resize", "value" => array("true") ),
			),
...
$settings  = array( 
	"name"       => __("Featured Image Options",'rt_theme_admin'),
